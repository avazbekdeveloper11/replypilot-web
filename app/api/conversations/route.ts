...
/**
 * Proxies GET /v1/conversations?status=&cursor=&limit=. Shared by the
 * Dashboard's Recent Conversations widget (limit only) and the full
 * Conversations page (status + cursor too, for filtering and
